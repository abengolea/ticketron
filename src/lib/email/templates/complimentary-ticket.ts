...
export function buildComplimentaryTicketEmailHtml(
  ...
  const messageSection = params.message?.trim()
    ? `
                <tr>
                  <td style="padding: 0 28px 24px 28px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-left: 3px solid ${EMAIL_BRAND.accent}; background-color: ${EMAIL_BRAND.accentSoft}; border-radius: 0 8px 8px 0;">
                      <tr>
                        <td style="padding: 14px 18px;">
                          <p style="margin: 0; font-family: ${EMAIL_BRAND.fontBody}; font-size: 15px; line-height: 1.7; color: ${EMAIL_BRAND.text}; font-style: italic;">${escapeHtml(params.message.trim())}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                  <td style="padding: 20px 28px 4px 28px;">
                    <p style="margin: 0; font-family: ${EMAIL_BRAND.fontBody}; font-size: 22px; font-weight: 700; line-height: 1.3; color: ${EMAIL_BRAND.text};">Hola, ${beneficiaryName}</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 8px 28px 28px 28px;">
                    <p style="margin: 0; font-family: ${EMAIL_BRAND.fontBody}; font-size: 15px; line-height: 1.7; color: ${EMAIL_BRAND.textMuted};">Te enviamos ${escapeHtml(ticketLabel)} para el siguiente evento. Tus códigos QR están abajo.</p>
                  </td>
                </tr>
