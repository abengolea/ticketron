...
import { Loader2, Plus, Settings2, Printer, History } from 'lucide-react';
    ...
    <section className="space-y-6">
      ...
      <Card className="border-primary/40 bg-primary/5">
        <CardContent className="pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <section>
            <p className="text-sm font-semibold text-primary">Impresión de tickets</p>
            <p className="text-sm text-muted-foreground mt-1">
              Generá tickets con QR para imprimir (PDF, ZIP). Distinto de la venta digital con Mercado Pago.
            </p>
          </section>
      ...
      <section className="flex justify-between items-center">
        ...
        <h1 className="text-2xl font-headline font-bold">Eventos (venta digital)</h1>
